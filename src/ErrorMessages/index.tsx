...
export const errorMessageChangeSalary = () => {
  toast.error('Error changing salary', {
    position: "top-right",
    autoClose: 5000,
    hideProgressBar: false,
    closeOnClick: true,
...
export const alreadyExistNameError = () => {
...
export const errorFillNameInput = () => {
...
export const errorFillSalaryInput = () => {
...
export const errorFillPaymentDayInput = () => {
